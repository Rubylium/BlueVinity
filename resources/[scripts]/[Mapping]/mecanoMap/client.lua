...
function Main()
	Menu.SetupMenu("mainmenu", "MECANO")
	Menu.Switch(nil, "mainmenu")
	 
	 Menu.addOption("mainmenu", function() if (Menu.Option("Faire spawn l'élévateur")) then
		 spawnProp("nacelle", elevatorBaseX, elevatorBaseY, elevatorBaseZ)
	 end end)
	 
	 Menu.addOption("mainmenu", function() if (Menu.Option("Supprimé l'élévateur")) then
