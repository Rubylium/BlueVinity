...
function AddSubMenuDanceMenu(menu)
	animDanceMenu = _menuPool:AddSubMenu(menu.SubMenu, _U('animation_dance_title'))

	local dance1 = NativeUI.CreateItem(_U('animation_dance_dance1'), "")
	animDanceMenu.SubMenu:AddItem(dance1)
	local dance2 = NativeUI.CreateItem(_U('animation_dance_dance2'), "")
	animDanceMenu.SubMenu:AddItem(dance2)
	local dance3 = NativeUI.CreateItem(_U('animation_dance_dance3'), "")
	animDanceMenu.SubMenu:AddItem(dance3)
	local dance4 = NativeUI.CreateItem(_U('animation_dance_dance4'), "")
	animDanceMenu.SubMenu:AddItem(dance4)
	local dance5 = NativeUI.CreateItem(_U('animation_dance_dance5'), "")
	animDanceMenu.SubMenu:AddItem(dance5)
	local dance6 = NativeUI.CreateItem(_U('animation_dance_dance6'), "")
	animDanceMenu.SubMenu:AddItem(dance6)
	local dance7 = NativeUI.CreateItem(_U('animation_dance_dance7'), "")
	animDanceMenu.SubMenu:AddItem(dance7)
	local dance8 = NativeUI.CreateItem(_U('animation_dance_dance8'), "")
	animDanceMenu.SubMenu:AddItem(dance8)
	local dance9 = NativeUI.CreateItem(_U('animation_dance_dance9'), "")
	animDanceMenu.SubMenu:AddItem(dance9)
	local dance10 = NativeUI.CreateItem(_U('animation_dance_dance10'), "")
	animDanceMenu.SubMenu:AddItem(dance10)
	local dance11 = NativeUI.CreateItem(_U('animation_dance_dance11'), "")
	animDanceMenu.SubMenu:AddItem(dance11)
	local dance12 = NativeUI.CreateItem(_U('animation_dance_dance12'), "")
	animDanceMenu.SubMenu:AddItem(dance12)
	local dance13 = NativeUI.CreateItem(_U('animation_dance_dance13'), "")
	animDanceMenu.SubMenu:AddItem(dance13)
	local dance14 = NativeUI.CreateItem(_U('animation_dance_dance14'), "")
	animDanceMenu.SubMenu:AddItem(dance14)
	local dance15 = NativeUI.CreateItem(_U('animation_dance_dance15'), "")
	animDanceMenu.SubMenu:AddItem(dance15)
	local dance16 = NativeUI.CreateItem(_U('animation_dance_dance16'), "")
	animDanceMenu.SubMenu:AddItem(dance16)
	local dance17 = NativeUI.CreateItem(_U('animation_dance_dance17'), "")
	animDanceMenu.SubMenu:AddItem(dance17)
	local dance18 = NativeUI.CreateItem(_U('animation_dance_dance18'), "")
	animDanceMenu.SubMenu:AddItem(dance18)
	local dance19 = NativeUI.CreateItem(_U('animation_dance_dance19'), "")
	animDanceMenu.SubMenu:AddItem(dance19)
	local dance20 = NativeUI.CreateItem(_U('animation_dance_dance20'), "")
	animDanceMenu.SubMenu:AddItem(dance20)
	local dance21 = NativeUI.CreateItem(_U('animation_dance_dance21'), "")
	animDanceMenu.SubMenu:AddItem(dance21)
	local dance22 = NativeUI.CreateItem(_U('animation_dance_dance22'), "")
	animDanceMenu.SubMenu:AddItem(dance22)
	local dance23 = NativeUI.CreateItem(_U('animation_dance_dance23'), "")
	animDanceMenu.SubMenu:AddItem(dance23)
	local dance24 = NativeUI.CreateItem(_U('animation_dance_dance24'), "")
	animDanceMenu.SubMenu:AddItem(dance24)
	local dance25 = NativeUI.CreateItem(_U('animation_dance_dance25'), "")
	animDanceMenu.SubMenu:AddItem(dance25)
	local dance26 = NativeUI.CreateItem(_U('animation_dance_dance26'), "")
	animDanceMenu.SubMenu:AddItem(dance26)
	local dance27 = NativeUI.CreateItem(_U('animation_dance_dance27'), "")
	animDanceMenu.SubMenu:AddItem(dance27)
	local dance28 = NativeUI.CreateItem(_U('animation_dance_dance28'), "")
	animDanceMenu.SubMenu:AddItem(dance28)
	local dance29 = NativeUI.CreateItem(_U('animation_dance_dance29'), "")
	animDanceMenu.SubMenu:AddItem(dance29)
	local dance30 = NativeUI.CreateItem(_U('animation_dance_dance30'), "")
	animDanceMenu.SubMenu:AddItem(dance30)
	local dance31 = NativeUI.CreateItem(_U('animation_dance_dance31'), "")
	animDanceMenu.SubMenu:AddItem(dance31)
	local dance32 = NativeUI.CreateItem(_U('animation_dance_dance32'), "")
	animDanceMenu.SubMenu:AddItem(dance32)
	local dance33 = NativeUI.CreateItem(_U('animation_dance_dance33'), "")
	animDanceMenu.SubMenu:AddItem(dance33)
	local dance34 = NativeUI.CreateItem(_U('animation_dance_dance34'), "")
	animDanceMenu.SubMenu:AddItem(dance34)
	local dance35 = NativeUI.CreateItem(_U('animation_dance_dance35'), "")
	animDanceMenu.SubMenu:AddItem(dance35)
	local dance36 = NativeUI.CreateItem(_U('animation_dance_dance36'), "")
	animDanceMenu.SubMenu:AddItem(dance36)
	local dance37 = NativeUI.CreateItem(_U('animation_dance_dance37'), "")
	animDanceMenu.SubMenu:AddItem(dance37)
	local dance38 = NativeUI.CreateItem(_U('animation_dance_dance38'), "")
	animDanceMenu.SubMenu:AddItem(dance38)
	local dance39 = NativeUI.CreateItem(_U('animation_dance_dance39'), "")
	animDanceMenu.SubMenu:AddItem(dance39)
	local dance40 = NativeUI.CreateItem(_U('animation_dance_dance40'), "")
	animDanceMenu.SubMenu:AddItem(dance40)

	animDanceMenu.SubMenu.OnItemSelect = function(sender, item, index)
		if item == dance1 then
			startAnim("anim@amb@nightclub@dancers@club_ambientpeds@med-hi_intensity", "mi-hi_amb_club_10_v1_male^6")
		elseif item == dance2 then
			startAnim("amb@code_human_in_car_mp_actions@dance@bodhi@ds@base", "idle_a_fp")
		elseif item == dance3 then
			startAnim("amb@code_human_in_car_mp_actions@dance@bodhi@rds@base", "idle_b")
		elseif item == dance4 then
			startAnim("amb@code_human_in_car_mp_actions@dance@std@ds@base", "idle_a")
		elseif item == dance5 then
			startAnim("anim@amb@nightclub@dancers@crowddance_facedj@hi_intensity", "hi_dance_facedj_09_v2_male^6")
		elseif item == dance6 then
			startAnim("anim@amb@nightclub@dancers@crowddance_facedj@low_intesnsity", "li_dance_facedj_09_v1_male^6")
		elseif item == dance7 then
