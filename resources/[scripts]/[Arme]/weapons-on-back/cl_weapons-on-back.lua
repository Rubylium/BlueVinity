...
Citizen.CreateThread(function()
  while true do
      ...
      for wep_name, wep_hash in pairs(SETTINGS2.compatable_weapon_hashes) do
        if HasPedGotWeapon(me, wep_hash, false) then
            if not attached_weapons[wep_name] then
                AttachWeapon(wep_name, wep_hash, SETTINGS2.back_bone, SETTINGS2.x, SETTINGS2.y, SETTINGS2.z, SETTINGS2.x_rotation, SETTINGS2.y_rotation, SETTINGS2.z_rotation, isMeleeWeapon(wep_name))
            end
        end
    end
      --------------------------------------------
