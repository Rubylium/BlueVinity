...
function OpenCloakroomMenu()
	...
	local elements = {
		...
		--{ label = 'Tenue SAHP', value = 'tenu_sahp' },
		--{ label = 'Tenue SAHP Gillet', value = 'tenu_sahpg' },
...
function OpenPoliceActionsMenu()
	...
	ESX.UI.Menu.Open('default', GetCurrentResourceName(), 'police_actions', {
		...
		elements = {
			...
			{label = ('Equipement LSPD'), value = 'lspd_equipement'},
			{label = ('Donner une ammende'), value = 'ammende'},
		...
		if data.current.value == 'citizen_interaction' then
			local elements = {
				...
				{label = 'Enlever les menottes', value = 'handcuff2'},
