...
AddEventHandler('esx_ammujob:drag', function(target)
  ...
  TriggerClientEvent('esx_ammujob:drag', target, _source)
end)
...
ESX.RegisterServerCallback('esx_ammujob:addArmoryWeapon', function(source, cb, weaponName)
...
ESX.RegisterServerCallback('esx_ammujob:buy', function(source, cb, amount)
