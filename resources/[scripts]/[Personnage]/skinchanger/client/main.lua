local Components = {
	{label = _U('sex'),						name = 'sex',				value = 0,		min = 0,	zoomOffset = 3.0,		camOffset = 0.65},
	{label = _U('face'),					name = 'face',				value = 0,		min = 0,	zoomOffset = 0.8,		camOffset = 0.65},
	{label = _U('skin'),					name = 'skin',				value = 0,		min = 0,	zoomOffset = 1.2,		camOffset = 0.65},
	...
	{label = _U('tshirt_1'),					name = 'tshirt_1',			value = 0,		min = 0,	zoomOffset = 3.0,		camOffset = 0.15},
	{label = _U('tshirt_2'),					name = 'tshirt_2',			value = 0,		min = 0,	zoomOffset = 3.0,		camOffset = 0.15,	textureof	= 'tshirt_1'},
	{label = _U('torso_1'),					name = 'torso_1',			value = 0,		min = 0,	zoomOffset = 3.0,		camOffset = 0.15},
	{label = _U('torso_2'),					name = 'torso_2',			value = 0,		min = 0,	zoomOffset = 3.0,		camOffset = 0.15,	textureof	= 'torso_1'},
	{label = _U('decals_1'),					name = 'decals_1',			value = 0,		min = 0,	zoomOffset = 3.0,		camOffset = 0.15},
	{label = _U('decals_2'),					name = 'decals_2',			value = 0,		min = 0,	zoomOffset = 3.0,		camOffset = 0.15,	textureof	= 'decals_1'},
	{label = _U('arms'),					name = 'arms',				value = 0,		min = 0,	zoomOffset = 3.0,		camOffset = 0.15},
	{label = _U('arms_2'),					name = 'arms_2',			value = 0,		min = 0,	zoomOffset = 3.0,		camOffset = 0.15},
	{label = _U('pants_1'),					name = 'pants_1',			value = 0,		min = 0,	zoomOffset = 3.0,		camOffset = -0.5},
	{label = _U('pants_2'),					name = 'pants_2',			value = 0,		min = 0,	zoomOffset = 3.0,		camOffset = -0.5,	textureof	= 'pants_1'},
