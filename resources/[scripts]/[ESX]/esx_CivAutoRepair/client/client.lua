		...
		if IsPedSittingInAnyVehicle(GetPlayerPed(-1)) then 
			for i = 1, #CivRepairStation do
				...
				if GetDistanceBetweenCoords(GetEntityCoords(GetPlayerPed(-1)), garageCoords2[1], garageCoords2[2], garageCoords2[3], true ) < 5 then
				 ESX.ShowHelpNotification('Appuyer sur ~INPUT_CONTEXT~ pour effectuer une réparation')
...
if insidemarkercheck == true and stage1 == true and stage2 == false and stage3 == false and stage4 == false and stage5 == false and stage6 == false then
 Draw3DText(1153.9860839844, -781.12658691406, 57.598682403564 + 0.2, tostring("~w~Votre vehicule est toujours en reparation ~o~revenez plus tard"))
  Draw3DText2(1153.9860839844, -781.12658691406, 57.598682403564, tostring("~w~Repair Status: ~r~25%"))
    Draw3DText2(1153.9860839844, -781.12658691406, 57.598682403564 - 0.2, tostring("~w~Verification global du vehicule .."))
end
...
if insidemarkercheck == true and stage1 == false and stage2 == true and stage3 == false and stage4 == false and stage5 == false and stage6 == false then
 ...
 Draw3DText2(1153.9860839844, -781.12658691406, 57.598682403564 - 0.2, tostring("~w~Reparation du moteur en cours .."))
end 
...
if insidemarkercheck == true and stage1 == false and stage2 == false and stage3 == true and stage4 == false and stage5 == false and stage6 == false then
 ...
 Draw3DText2(1153.9860839844, -781.12658691406, 57.598682403564 - 0.2, tostring("~w~Reparation de la transmission en cours .."))
end 
...
if insidemarkercheck == true and stage1 == false and stage2 == false and stage3 == false and stage4 == false and stage5 == true and stage6 == false then
 ...
 Draw3DText2(1153.9860839844, -781.12658691406, 57.598682403564 - 0.2, tostring("~w~Nettoyage final en cours.."))
end 
...
if insidemarkercheck == true and stage1 == false and stage2 == false and stage3 == false and stage4 == false and stage5 == false and stage6 == true then
 Draw3DText(1153.9860839844, -781.12658691406, 57.598682403564 + 0.2, tostring("~w~Votre vehicule est toujours en reparation ~o~revenez plus tard"))
	           Draw3DText2(1153.9860839844, -781.12658691406, 57.598682403564, tostring("~w~Repair Status: ~g~100%"))
	            Draw3DText2(1153.9860839844, -781.12658691406, 57.598682403564 - 0.2, tostring("~w~Tout est finit!"))
end 
...
if locked == true then
--Draw3DText2(plyPos.x, plyPos.y, plyPos.z + 0.2, tostring('~w~Le vehicule à été ~r~vérouiller'))
end

if unlocked == true then
--Draw3DText2(plyPos.x, plyPos.y, plyPos.z + 0.2, tostring('~w~Le vehicule à été ~g~déverouiller'))
end
...
Draw3DText2(plyPos.x, plyPos.y, plyPos.z + 0.2, tostring('~w~La reparation vas commencer ...'))

end

if paynotification == true then

Draw3DText2(plyPos.x, plyPos.y, plyPos.z + 0.2, tostring('~w~Vous avez paye ~w~pour les reparations'))
end

if stage6 == true then
Draw3DText(plyPos.x, plyPos.y, plyPos.z + 0.2, tostring("~w~Votre vehicule est ~g~pret ~w~a etre recupere "))
--Draw3DText2(plyPos.x, plyPos.y, plyPos.z + 0.1, tostring("~w~Appuyer sur ~r~E~w~ pour vérouiller votre voiture au shop"))
end

if stage7 == true then
Draw3DText(plyPos.x, plyPos.y, plyPos.z, tostring("~r~Mmh ..."))
end
		Citizen.Wait(0)
	end
end)
...
--	TriggerEvent('chatMessage', 'Bilvasken', {255, 0, 0}, "Du har ikke penge nok, du mangler ^1kr" .. moneyleft .. "") -- danish
	TriggerEvent('chatMessage', 'CivRepair', {255, 0, 0}, "Tu n'a pas assez d'argent, il te manque ^1" .. moneyleft .. "$") 
	DrawSpecialText(msg, 5000)
	Wait(5000)
end)
    --[[ 
...
--	TriggerEvent('chatMessage', 'Bilvasken', {255, 0, 0}, "Du har ikke penge nok, du mangler ^1kr" .. moneyleft .. "") -- danish
	TriggerEvent('chatMessage', 'CivRepair', {255, 0, 0}, "Tu n'a pas assez d'argent pour le ^3Premium^0 il te manque ^1" .. moneyleft .. "$") 
	DrawSpecialText(msg, 5000)
	Wait(5000)
end)
...
function AutoRepair() -- Credits qalle for assisting with this 
    ...
    local elements = {
        { label = 'Réparation rapide <font color="lightblue">⭐Premium⭐</font><font color="red">$2000</font>', value = "repair_fast" },
        { label = 'Réparation <font color="orange">💤Regular💤</font><font color="red">$500</font>', value = "repair_slow" }
    }
