		...
		if(IsPedInAnyVehicle(MyPed, false))then
			...
			if HUD.Top then
				...
				if (VehEngineHP > 0) and (VehEngineHP < 300) then
					drawTxt(UI.x + 0.619, UI.y + 1.266, 1.0,1.0,0.45, "~y~Fluide", 255, 255, 255, 200)
				...
				elseif VehEngineHP < 1 then 
					...
					drawTxt(UI.x + 0.514, UI.y + 1.269, 1.0,1.0,0.45, "~w~~r~Huile", 255, 255, 255, 200)
					drawTxt(UI.x + 0.645, UI.y + 1.270, 1.0,1.0,0.45, "~r~AC", 255, 255, 255, 200)
				else
					drawTxt(UI.x + 0.619, UI.y + 1.266, 1.0,1.0,0.45, "Fluide", 255, 255, 255, 150)
					drawTxt(UI.x + 0.514, UI.y + 1.269, 1.0,1.0,0.45, "Huile", 255, 255, 255, 150)
