Config = {
    ...
    Items = {
        ["drinks"] = {
            {label = "Coca Cola", item = "cocacola", price = 3},
            {label = "Fanta Exotic", item = "fanta", price = 3},
            {label = "Sprite", item = "sprite", price = 3},
            {label = "Loka Crush", item = "loka", price = 3},
        },
        ["snacks"] = {
            {label = "Chips fromage", item = "cheesebows", price = 4},
            {label = "Chips barbecue", item = "chips", price = 4},
        },
        ["readymeal"] = {
            {label = "Kebab Pizza", item = "pizza", price = 7},
            {label = "Bacon Burgare", item = "burger", price = 8},
            {label = "Pasta Carbonara", item = "pastacarbonara", price = 4},
        },
        ["diverse"] = {
            {label = "Briquet", item = "lighter", price = 5},
            {label = "Jumelles", item = "jumelles", price = 25},
