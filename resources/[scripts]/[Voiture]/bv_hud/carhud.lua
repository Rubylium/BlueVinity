	...
	--  ####         	 PLANE HUD	  	  	  ####  --			
			...
			if HUD.CarGears and PedHeli == false and PedPlane == false and PedBoat == false then
				if VehStopped and (Speed == 0) then
					drawTxt(UI.x + 0.661, UI.y + 1.245, 1.0,1.0,0.45, "P", 255, 0, 0, 200)
				elseif Gear < 1 then
					drawTxt(UI.x + 0.661, UI.y + 1.245, 1.0,1.0,0.45, "R", 255, 255, 255, 200)						
				elseif Gear == 1 then
					drawTxt(UI.x + 0.661, UI.y + 1.245, 1.0,1.0,0.45, "1", 255, 255, 255, 200)
				elseif Gear == 2 then
					drawTxt(UI.x + 0.661, UI.y + 1.245, 1.0,1.0,0.45, "2", 255, 255, 255, 200)
				elseif Gear == 3 then
					drawTxt(UI.x + 0.661, UI.y + 1.245, 1.0,1.0,0.45, "3", 255, 255, 255, 200)
				elseif Gear == 4 then
					drawTxt(UI.x + 0.661, UI.y + 1.245, 1.0,1.0,0.45, "4", 255, 255, 255, 200)
				elseif Gear == 5 then
					drawTxt(UI.x + 0.661, UI.y + 1.245, 1.0,1.0,0.45, "5", 255, 255, 255, 200)
				elseif Gear == 6 then
					drawTxt(UI.x + 0.661, UI.y + 1.245, 1.0,1.0,0.45, "6", 255, 255, 255, 200)
				elseif Gear == 7 then
					drawTxt(UI.x + 0.661, UI.y + 1.245, 1.0,1.0,0.45, "7", 255, 255, 255, 200)
				elseif Gear == 8 then
					drawTxt(UI.x + 0.661, UI.y + 1.245, 1.0,1.0,0.45, "8", 255, 255, 255, 200)
				end	
			end
			...
			if HUD.Top and PedHeli == false and PedPlane == false and PedBoat == false then
				...
				elseif (VehEngineHP > 111) and (VehEngineHP < EngineHpAlmostBroken) then 
					...
					drawTxt(UI.x + 0.619, UI.y + 1.245, 1.0,1.0,0.45, "MOTEUR", 255, 255, 0,200)
				else
					...
					drawTxt(UI.x + 0.619, UI.y + 1.245, 1.0,1.0,0.45, "MOTEUR", 0, 255, 0,200)
				end
			...
			if HUD.Engine and PedHeli == false and PedPlane == false and PedBoat == false then
				if EngineRunning then
					drawTxt(UI.x + 0.619, UI.y + 1.245, 1.0,1.0,0.45, "MOTEUR", 0, 255, 0,200) -- ENG green
				else
					drawTxt(UI.x + 0.619, UI.y + 1.245, 1.0,1.0,0.45, "MOTEUR", 255, 0, 0, 200) -- ENG red
					RPM = 0
				end
			end
