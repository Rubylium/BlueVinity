...
AddEventHandler("StreetRaces:createRace_sv", function(amount, startDelay, startCoords, checkpoints, finishTimeout)
	...
	for i=1, #xPlayers, 1 do
		...
		if xPlayer.job.name == 'police' then
            ...
            TriggerClientEvent("StreetRaces:createRace_cl", xPlayers[i], index, amount, startDelay, startCoords, checkpoints)
            --TriggerClientEvent('chatMessage', xPlayers[i], "[Course de rue]", {255, 0, 0}, "Une cours de rue illégal vas commencer ! Regarder votre GPS !")
		end
	end
end)
