...
PerformHttpRequest(DiscordServeurON, function(Error, Content, Head) end, 'POST', json.encode({username = SystemName, content = '**Blue Vinity Information**\n```diff\n+ Le serveur vient de démarrer !```'}), { ['Content-Type'] = 'application/json' })
-- System Infos
