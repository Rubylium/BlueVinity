...
--- CONFIG ---
local attempts = 1 -- Amount of attempts a user can have
...
AddEventHandler("Fax:ServerPassword:ShowPasswordPrompt", function()
    local password = KeyboardInput("Mots de passe ? discord.gg/MKZHvf2(" .. attempts .. " essai" .. (attempts == 1 and "" or "s") .. " restant)", "", 30)
    attempts = attempts - 1
