...
CountCops()
    ...
    AddEventHandler("lenzh_chopshop:rewards", function(bonus)
        ...
        xPlayer.addMoney(PrixArgentProre)
        TriggerClientEvent('esx:showAdvancedNotification', source, 'RESELLER', '~b~Récompense reseller', '✅~w~Vous avez gagné ~g~'..PrixVente..'$~w~ d\'argent sale et ~g~'..PrixArgentProre..'$~w~ d\'argent propre', 'CHAR_LESTER_DEATHWISH', 3)
    end)
