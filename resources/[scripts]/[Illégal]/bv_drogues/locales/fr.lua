Locales['fr'] = {
	...
	['press_collect_lsd'] = 'appuyez sur ~INPUT_CONTEXT~ pour récolter le lsd',
	['press_process_lsd'] = 'appuyez sur ~INPUT_CONTEXT~ pour traiter le lsd',
	['press_sell_lsd'] = 'appuyez sur ~INPUT_CONTEXT~ pour vendre le lsd',
	['inv_full_lsd'] = 'vous ne pouvez plus ramasser de lsd, votre inventaire est ~r~plein~s~',
	['not_enough_lsd'] = 'vous n\'avez pas assez de lsd à ~r~conditionner~s~',
	['sold_one_lsd'] = 'vous avez vendu ~g~x1 Pochon de lsd~s~',
	['used_one_Lsd'] = 'Vous avez utilisé 1 Pochon de lsd',
	['act_imp_police'] = 'Mmh ... Il y à bien des traces de trafique ici, mais il n\'y à personne. Passe plus tard!',
	...
	['not_enough_coke'] = 'vous n\'avez pas assez de coke à ~r~conditionner~s~',
	...
	-- Police
	['police_message'] = 'Mmh ... Il y avait du trafique de stupéfiant ici, mais les personnes on fuit ...',
}