...
Citizen.CreateThread(function()
	while true do
		Citizen.Wait(5000)
		PrixPolicierCoke = CopsConnected * 13
		local r = math.random(95, 110) + PrixPolicierCoke
		PrixCoke = r
	end
end)
...
Citizen.CreateThread(function()
	while true do
		Citizen.Wait(2000)
		PrixPolicierMeth = CopsConnected * 15
		local r = math.random(125, 130) + PrixPolicierMeth
		PrixMeth = r
	end
end)
...
Citizen.CreateThread(function()
	while true do
		...
		local r = math.random(70, 75) + PrixPolicierWeed
		PrixWeed = r
	end
end)
...
Citizen.CreateThread(function()
	while true do
		...
		local r = math.random(150, 165) + PrixPolicierOpium
		PrixOpium = r
	end
end)
