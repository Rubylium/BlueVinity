...
RegisterNetEvent('esx_weashop:PlaySoundSucces')
AddEventHandler('esx_weashop:PlaySoundSucces', function (licenses)
  ESX.ShowAdvancedNotification('Vendeur d\'arme', 'License aquise.', 'Merci de votre achats, qu\'es que vous voulez maintenant ?', 'CHAR_AMMUNATION', 1)
  PlaySoundFrontend(-1, "CHALLENGE_UNLOCKED", "HUD_AWARDS", 0)
end)

RegisterNetEvent('esx_weashop:PlaySoundRater')
AddEventHandler('esx_weashop:PlaySoundRater', function (licenses)
  ESX.ShowAdvancedNotification('Vendeur d\'arme', 'License non aquise.', 'Désolé mais ta pas assez d\'argent, revient plus tard.', 'CHAR_AMMUNATION', 1)
...
function OpenBuyLicenseMenu (zone)
  PlaySoundFrontend(-1, "Apt_Style_Purchase", "DLC_APT_Apartment_SoundSet", 0)
	Citizen.Wait(100)
	ESX.ShowAdvancedNotification('Vendeur d\'arme', 'Acheter votre license.', 'Vous voulez des armes ? Pas de problèmes mais faudrat une license avant.', 'CHAR_AMMUNATION', 1)
...
function OpenShopMenu(zone)
  PlaySoundFrontend(-1, "Mission_Pass_Notify", "DLC_HEISTS_GENERAL_FRONTEND_SOUNDS", 0)
	Citizen.Wait(100)
	ESX.ShowAdvancedNotification('Vendeur d\'arme', 'Besoin de s\'armer ?.', 'Vous voulez des armes ? Pas de problèmes j\'ai de tout.', 'CHAR_AMMUNATION', 1)
  local elements = {}
