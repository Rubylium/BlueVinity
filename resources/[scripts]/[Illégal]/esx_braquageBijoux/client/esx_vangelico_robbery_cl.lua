...
AddEventHandler('esx_vangelico_robbery:setblip', function(position)
	...
	loopAlarm = true
	TriggerEvent('esx_vangelico_robbery:loopAlarmTriggered')
end)

RegisterNetEvent('esx_vangelico_robbery:loopAlarmTriggered')
AddEventHandler('esx_vangelico_robbery:loopAlarmTriggered', function()
	while loopAlarm do
...
RegisterNetEvent('esx_vangelico_robbery:BraquageAnnule')
AddEventHandler('esx_vangelico_robbery:BraquageAnnule', function()
	PlaySoundFrontend(-1, "Event_Start_Text", "GTAO_FM_Events_Soundset", 0)
	Citizen.Wait(100)
...
RegisterNetEvent('esx_vangelico_robbery:BraquageFinit')
AddEventHandler('esx_vangelico_robbery:BraquageFinit', function()
	PlaySoundFrontend(-1, "Event_Start_Text", "GTAO_FM_Events_Soundset", 0)
	Citizen.Wait(500)
...
RegisterNetEvent('esx_vangelico_robbery:VenteBijoux')
AddEventHandler('esx_vangelico_robbery:VenteBijoux', function()
	PlaySoundFrontend(-1, "Event_Start_Text", "GTAO_FM_Events_Soundset", 0)
	Citizen.Wait(500)
...
RegisterNetEvent('esx_vangelico_robbery:VenteBijouxRefuser')
AddEventHandler('esx_vangelico_robbery:VenteBijouxRefuser', function()
	PlaySoundFrontend(-1, "Event_Start_Text", "GTAO_FM_Events_Soundset", 0)
	Citizen.Wait(500)
    ...
    while true do
       ...
       playerPed = GetPlayerPed(-1)
		...
		if pos then
				...
				if GetDistanceBetweenCoords(GetEntityCoords(GetPlayerPed(-1)), 1269.678, -1709.697, 53.50, true) <= 2 then
